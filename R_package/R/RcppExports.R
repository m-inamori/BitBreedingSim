...
modify_Trait_Params_AD_wrapper <- function(baseInfoPtr, i, h2_ = NULL, a_ = NULL, am_ = NULL, d_ = NULL, dm_ = NULL) {
    invisible(.Call(`_BitBreedingSim_modify_Trait_Params_AD_wrapper`, baseInfoPtr, i, h2_, a_, am_, d_, dm_))
}
